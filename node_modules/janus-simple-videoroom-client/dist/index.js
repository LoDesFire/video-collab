...
function createVideoRoomSession(server, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield new Promise(function (fulfill, reject) {
            let resolved = false;
            session = new janus_gateway_1.default(Object.assign(Object.assign({}, options), {
                server,
                success() {
                    if (!resolved) {
                        fulfill();
        ...
        return {
            ...
            joinRoom(roomId, token) {
                return joinVideoRoom(session, roomId, token);
            },
...
function joinVideoRoom(session, roomId, token) {
    return __awaiter(this, void 0, void 0, function* () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const offerJsep = yield new Promise(function (fulfill, reject) {
                ...
                handle.createOffer(Object.assign(Object.assign({}, options.mediaOptions), {
                    success: fulfill,
                    error: reject
                }));
            });
            ...
            return {
                ...
                restart(mediaOptions = options.mediaOptions) {
                    return __awaiter(this, void 0, void 0, function* () {
                        const offerJsep = yield new Promise(function (fulfill, reject) {
                            handle.createOffer(Object.assign(Object.assign({}, mediaOptions), {
                                success: fulfill,
                                error: reject
                            }));
                        });
        ...
        try {
            ...
            return {
                ...
                configure(configureOptions) {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield handle.sendAsyncRequest({
                            message: Object.assign(Object.assign({}, configureOptions), {
                                request: "configure",
                                restart: false
                            }),
                            expectResponse: r => r.message.videoroom == "event" && r.message.configured == "ok"
...
function createStreamingSubscriber(session, mountPointId, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield handle.sendAsyncRequest({
                message: Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.watchOptions), {
                    request: "watch",
                    id: mountPointId
                }),
                expectResponse: r => {
                    var _a;
                    return r.message.streaming == "event" && ((_a = r.message.result) === null || _a === void 0 ? void 0 : _a.status) == "preparing";
                }
            });
            if (!response.jsep)
                throw new Error("Missing offer Jsep");
            ...
            return {
                ...
                pause() {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield handle.sendAsyncRequest({
                            ...
                            expectResponse: r => {
                                var _a;
                                return r.message.streaming == "event" && ((_a = r.message.result) === null || _a === void 0 ? void 0 : _a.status) == "pausing";
                            }
                        });
                    });
                },
                resume() {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield handle.sendAsyncRequest({
                            ...
                            expectResponse: r => {
                                var _a;
                                return r.message.streaming == "event" && ((_a = r.message.result) === null || _a === void 0 ? void 0 : _a.status) == "starting";
                            }
                        });
                    });
                },
                configure(configureOptions) {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield handle.sendAsyncRequest({
                            ...
                            expectResponse: r => {
                                var _a;
                                return r.message.streaming == "event" && ((_a = r.message.result) === null || _a === void 0 ? void 0 : _a.event) == "configured";
                            }
                        });
                    });
                },
                switch(newMountPointId) {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield handle.sendAsyncRequest({
                            ...
                            expectResponse: r => {
                                var _a;
                                return r.message.streaming == "event" && ((_a = r.message.result) === null || _a === void 0 ? void 0 : _a.switched) == "ok";
                            }
                        });
                ...
                restart(newOptions = options) {
                    return __awaiter(this, void 0, void 0, function* () {
                        const response = yield handle.sendAsyncRequest({
                            message: Object.assign(Object.assign({}, newOptions === null || newOptions === void 0 ? void 0 : newOptions.watchOptions), {
                                request: "watch",
                                id: mountPointId
                            }),
                            expectResponse: r => {
...
function handleOffer(handle, offerJsep, mediaOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const answerJsep = yield new Promise(function (fulfill, reject) {
            ...
            handle.createAnswer(Object.assign(Object.assign({}, mediaOptions), {
                jsep: offerJsep,
                success: fulfill,
                error: reject
            }));

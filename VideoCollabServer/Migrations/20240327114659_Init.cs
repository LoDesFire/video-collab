    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PinnedMoviesId = table.Column<int>(type: "INTEGER", nullable: false),
                    UsersPinnedMovieId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieUser", x => new { x.PinnedMoviesId, x.UsersPinnedMovieId });
                    table.ForeignKey(
                        name: "FK_MovieUser_AspNetUsers_UsersPinnedMovieId",
                        column: x => x.UsersPinnedMovieId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieUser_Movies_PinnedMoviesId",
                        column: x => x.PinnedMoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InviteLinkId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConnectedRoomsId = table.Column<int>(type: "INTEGER", nullable: false),
                    UsersId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomUsers", x => new { x.ConnectedRoomsId, x.UsersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieUser_UsersPinnedMovieId",
                table: "MovieUser",
                column: "UsersPinnedMovieId");

...
namespace VideoCollab.Core.Utils
{
    public static class ImageDimensions
    {
        ...
        private static readonly Dictionary<byte[], Func<BinaryReader, Size>> ImageFormatDecoders = new()
        {
            ...
            { [0x47, 0x49, 0x46, 0x38, 0x37, 0x61], DecodeGif },
            { [0x47, 0x49, 0x46, 0x38, 0x39, 0x61], DecodeGif },
            { [0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A], DecodePng },
            { [0xff, 0xd8], DecodeJfif },
        };
        ...
        public static Size GetDimensions(string path)
        {
            ...
            catch (ArgumentException e)
            {
                ...
                {
                    throw new ArgumentException(ErrorMessage, nameof(path), e);
                }
